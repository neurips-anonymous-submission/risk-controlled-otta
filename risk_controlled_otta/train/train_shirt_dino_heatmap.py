...
def main(args) -> None:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        torch.save(ckpt, output_dir / "last_shirt_source_dino_heatmap.pth")

        if val_loss < best_val:
            best_val = val_loss
            torch.save(ckpt, output_dir / "best_shirt_source_dino_heatmap.pth")
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="output/dinov3_heatmap_shirt_source_v1")

    parser.add_argument("--model_name", type=str, default="vit_base_patch16_dinov3.lvd1689m")
    parser.add_argument("--pretrained_path", type=str, default="pretrained/dinov3_base/model.safetensors")

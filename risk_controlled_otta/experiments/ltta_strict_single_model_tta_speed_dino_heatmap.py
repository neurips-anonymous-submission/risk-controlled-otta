...
def _load_original_module() -> ModuleType:
    source_path = Path(__file__).with_name("ltta_strict_single_model_tta_speed_dino_heatmap (1).py")
    spec = importlib.util.spec_from_file_location("ltta_strict_single_model_tta_speed_dino_heatmap_orig", source_path)

...
def run_learnable_trigger_tta(args) -> None:
    ...
    for step, batch in enumerate(tqdm(target_loader, desc="learnable_trigger_dual_branch_v2"), start=1):
    ...
    checkpoint = {
        ...
        "adaptation": "learnable_trigger_single_model_tta_dual_branch_v2",
        "trigger_mode": "dual_branch",
        "gate_usage": args.gate_usage,
        "update_scope": args.update_scope,
        "summary": summary,
...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="output/dinov3_heatmap_dual_branch_lightbox_v2")
    ...
    parser.add_argument("--gate_usage", type=str, choices=["hard", "soft_loss", "soft_lr"], default="soft_lr")
    ...
    parser.add_argument("--memory_min_confidence", type=float, default=0.40)
    parser.add_argument("--memory_min_inliers", type=int, default=6)
    parser.add_argument("--memory_max_reproj_error", type=float, default=8.0)
    ...
    parser.add_argument("--lambda_self_training", type=float, default=0.25)
    parser.add_argument("--lambda_geo", type=float, default=0.35)
    ...
    parser.add_argument("--geo_boost_max_reproj", type=float, default=5.5)

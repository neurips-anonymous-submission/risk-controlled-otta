...
TTA_OUTPUT_DIR="output/dinov3_heatmap_speed_dual_branch_tta_sunlamp"
...
# ==========================================
# 2. 运行 Dual-Branch Learnable TTA
# ==========================================
echo ">>> [1/2] 开始运行 DINOv3 Dual-Branch Learnable TTA..."
...
# 3. 运行评估
# ==========================================
echo ">>> [2/2] 评估 Dual-Branch TTA 适应后的模型..."
...
echo ">>> [完成] Dual-Branch TTA 跨域评估结束！"

...
# 修改了输出文件夹名字，方便和 MLP-Geo 区分
TTA_OUTPUT_DIR="${TTA_OUTPUT_DIR:-output/dinov2_heatmap_dual_branch_tta_${TARGET_SPLIT}}"
...
echo "=================================================="
echo "[1/2] Running Dual-Branch Triggered TTA"
echo "=================================================="
...
echo "=================================================="
echo "[DONE] TTA checkpoint: ${TTA_CHECKPOINT}"
echo "=================================================="

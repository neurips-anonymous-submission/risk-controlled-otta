...
# SHIRT Learnable-Trigger TTA: MLP-Geo version
...
TTA_OUTPUT_DIR="${TTA_OUTPUT_DIR:-output/dinov3_heatmap_shirt_mlp_geo_tta_v1}"
...
echo "[1/2] Running SHIRT learnable-trigger TTA: MLP-Geo"
python "${TTA_SCRIPT}" \
  --data_root "${DATA_ROOT}" \
...
echo "[2/2] Evaluating MLP-Geo TTA-adapted model"

...
# 更新了输出文件夹的命名，以区分这是对齐版本的实验结果
OUT_DIR=./output/tta_vitpose_aligned_lightbox
EVAL_DIR=./output/eval_tta_vitpose_aligned_lightbox

echo "======================================"
echo "1. 启动 ViTPose 对齐版 OTTA 训练..."
echo "======================================"

python online_tta_vitpose_aligned.py \
  --data_root speedplusv2 \
  --source_checkpoint ../otta/output/source_paper_aligned/best_source.pth \
